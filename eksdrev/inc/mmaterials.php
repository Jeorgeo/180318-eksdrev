<?php
add_action('init', 'register_post_types_mmat');
function register_post_types_mmat(){
	register_post_type('mmaterials', array(
		'label'  => 'mmaterials',
		'labels' => array(
			'name'               => 'Материалы массив', // основное название для типа записи
			...
			'menu_name'          => 'Материалы массив', // название меню
		),
		'description'         => '',
		'public'              => true,
