	...
	<section class="materials" id="materials">
		...
		<div class="materials__cards">
			...
			<figure class="materials__card">
				<a href="<?php echo get_field('materials-img_s', $obj->ID); ?>" data-lightbox="roadtrip" data-title="<?php echo get_field('materials-title', $obj->ID); ?>">
					<img src="<?php echo get_field('materials-img', $obj->ID); ?>" alt="ЛидаЭксДрев <?php echo get_field('materials-title', $obj->ID); ?>">
				</a>
				<p>
